...
<section class="bg-gray-100 fixed ml-72 px-11 py-6 w-full top-20 left-0"> 
    <p class="text-sm text-gray-600">
        ...
        <a a href="/DASHBORDandingpage_employee">Dashboard</a> / Overdue Reports
    </p>
</section>
                    ...
                    <table class="min-w-full bg-white border border-gray-200">
                        <thead>
                            <tr class="bg-[#012A4A] text-white">
                                ...
                                <th class="py-2 px-4 text-center">Overdue Date</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="py-3 px-4">9780553380163</td>
                                <td class="py-3 px-4">General knowledge</td>
                                <td class="py-3 px-4">Jan 2, 2025</td>
                                <td class="py-3 px-4">Jan 3, 2025</td>
                            </tr>
