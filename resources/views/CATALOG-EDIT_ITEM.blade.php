...
<div class="bg-white border border-gray-300 rounded-lg h-[75vh] overflow-y-auto shadow-sm fixed top-[calc(8rem+1rem)] left-[59%] transform -translate-x-1/2 w-3/4">
    ...
    <div class="rounded-md p-6">
        <h2 class="text-lg font-semibold text-gray-800 border-b-2 border-gray-200 pb-2">Item Information</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">

            <!-- Cover Photo Section -->
            <div class="flex flex-col items-center">
                <img src="/path/to/default-cover.jpg" alt="Book Cover" class="w-40 h-60 object-cover border rounded-lg shadow-md mb-4">
